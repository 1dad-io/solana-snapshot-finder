...
- If a full snapshot has already been downloaded locally for a candidate base slot, the tool switches into incremental-only recovery for that base slot and avoids downloading newer full snapshots during the same search flow.
